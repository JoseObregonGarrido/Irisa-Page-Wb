...
// Reutilizamos un componente de celda interno para mayor limpieza visual
                    ...
                    <tr className="bg-gray-50 border-b border-gray-200 text-[10px] font-bold text-gray-500 uppercase tracking-wider">
                        ...
                        {hasUeTransmitter && (
                            <>
                                ...
                                <th className="px-3 py-4 text-center">Tx UE</th>
                                <th className="px-3 py-4 text-center bg-red-50 text-red-700">Err UE</th>
                            </>
                        )}
                        ...
                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                            ...
                            {hasUeTransmitter && (
                                <>
                                    ...
                                    <td className="p-2"><TableInput unit="UE" value={m.ueTransmitter} onChange={(e:any) => onChange(index, 'ueTransmitter', e.target.value)} bgColor="bg-yellow-50" /></td>
                                    <td className="p-2 bg-red-50/20"><TableInput unit="UE" value={m.errorUE} readOnly isError /></td>
                                </>
                            )}
