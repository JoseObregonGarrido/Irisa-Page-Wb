                ...
                <div className="bg-white divide-y divide-gray-200">
                    {measurements.map((m: Measurement, index: number) => (
                        ...
                        >
                            ...
                            <div className="lg:p-2"><InputField label="mA sensor" unit="mA" value={m.maTransmitter} onChange={(e:any) => onChange(index, 'maTransmitter', e.target.value)} /></div>
                            <div className="lg:p-2"><InputField label="Ω sensor" unit="Ω" value={m.ohmTransmitter} onChange={(e:any) => onChange(index, 'ohmTransmitter', e.target.value)} /></div>
